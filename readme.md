...
-   `userBearing` **number** current user bearing. If provided, the user must be within a certain threadhold of the steps exit bearing to successful complete a step.
